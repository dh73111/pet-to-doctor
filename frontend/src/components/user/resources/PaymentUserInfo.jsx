        ...
        <Box sx={{ display: 'flex' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%', /* backgroundColor: '#CDEEF4' */ }}>
                <Grid container sx={gridContainer}>
                    <Typography item xs={12} sx={shipmentLabel}>이름</Typography>
                    <TextField sx={{ flex: 1, maxWidth: '260px' }} id="outlined-basic" variant="outlined" size="small" value={userInfo.name}/>
                </Grid>
                <Grid container sx={gridContainer}>
                    <Typography item xs={12} sx={shipmentLabel}>전화번호</Typography>
                    <TextField sx={{ flex: 1, maxWidth: '260px' }} id="outlined-basic" variant="outlined" size="small" value={userInfo.tel}/>
                </Grid>
                <Grid container sx={gridContainer}>
