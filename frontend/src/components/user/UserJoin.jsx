    ...
    <div>
      ...
      >
        ...
        >
          ...
          <Grid>
            <TextField style={{ width: 350 }} margin="dense" id="name" name="name" value={pet.name} onChange={handlePetChange("name")} />
          </Grid>
        </Grid>
        <Grid
          container
        ...
        >
          ...
          <Grid>
            <TextField style={{ width: 350 }} margin="dense" id="species" name="species" value={pet.species} onChange={handlePetChange("species")} />
          </Grid>
        </Grid>
        <Grid
          container
