              ...
              <Grid container sx={{ mt: 1 }}>
                {doctor.doctorList.map((item, index) => (
                  <Grid item md={6} key={index}>
                    ...
                    <Grid item md={10}>
                      <Box>
                        <img src={`${process.env.PUBLIC_URL}/img/loginDog.jpg`} alt="의사사진" width="100%" height="150"></img>
                      </Box>
                      <Box>{item.name}</Box>
                    </Grid>
      ...
      return (
        <Box>
          {doctor.doctorList.map((item, index) => (
            <Grid container>
              <Grid item xs={4.3}>
                <img src={`${process.env.PUBLIC_URL}/img/loginDog.jpg`} alt="의사사진" width="150px" height="150"></img>
              </Grid>
      ...
      <Grid container>
        <Grid item xs={3.3}>
          ...
          <Paper style={{ maxHeight: 890, overflow: "auto" }} elevation={0}>
            <img src={`${process.env.PUBLIC_URL}/img/hospital.png`} style={{ height: "200px", width: "100%" }} alt="병원 이미지"></img>

            <Box display="flex" justifyContent="center" alignItems="center" sx={{ mt: 1 }}>
              {hospital.fullTime ? <img src={`${process.env.PUBLIC_URL}/img/24hospital.png`} alt="24시여부"></img> : <Box>24 안열어</Box>}
            </Box>
            <Box display="flex" justifyContent="center" alignItems="center" sx={{ mt: 2, fontSize: 25, fontWeight: "bold" }}>
              {hospital.name}
            </Box>
            <Box display="flex" justifyContent="center" alignItems="center" sx={{ mt: 1, fontSize: 15, fontWeight: "bold" }}>
              <Grid container>
                <Grid item xs={4} />
      ...
      <Grid item xs={12} md={2.5}>
        ...
        <Paper style={{ maxHeight: 820, overflow: "auto", WebkitScrollSnapType: "none" }}>
          {hospitalList.map((item, index) => (
            <Hospital key={index} hospital={item.hospital} index={index} reviewList={item.reviewList}></Hospital>
          ))}
        </Paper>
      </Grid>
