            ...
            <Container>
                <Grid container sx={{ pt: 8 }} spacing={5}>
                    <Grid item xs={12} md={6}>
                        <Typography sx={{ color: "#687274", fontWeight: "bold", fontSize: "20px" }}>Pet to Doctor(펫투닥터)</Typography>
                        <Typography sx={{ mt: 2, fontSize: "15px", color: "#8C999B" }}>곽명필, 김두회, 김정빈, 박다원, 이준형, 정지욱</Typography>
