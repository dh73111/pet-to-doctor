  ...
  return (
    <Box style={{ border: 1 }}>
      <MyImage>
        ...
        <Typography className="mainTitle" sx={{ fontSize: "36px", pt: 23 }} textAlign="center">
          대충 진심으로 진료한다는 말<br />" 펫투닥터로 우리아이 건강을 지켜주세요 "
        </Typography>
      </MyImage>
      <Container sx={{ mt: 4 }}>
      ...
      <Box sx={{ width: "100%" }}>
        <Grid container rowSpacing={22} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          ...
          <Grid item xs={12}>
            <img src={`${process.env.PUBLIC_URL}/img/mainDesc.png`} width="100%" alt="" />
          </Grid>
          <Grid item xs={2.4}></Grid>
          <Grid item xs={7.2}>
            <img src={`${process.env.PUBLIC_URL}/img/mainDesc2.png`} width="100%" alt="" />
          </Grid>
          <Grid item xs={2.4}></Grid>
        </Grid>
      </Box>
